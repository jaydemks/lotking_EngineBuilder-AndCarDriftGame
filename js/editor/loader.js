...
const EDITOR_SCRIPT_STAGES = Object.freeze([
  ...
  [.75, 'loading device visuals', 'js/runtime/input/device-visuals.js'],
	  ...
	  [.76, 'loading logic graph', 'js/logic/logic-graph.js?v=0.7.4-free-camera-1'],
  [.7605, 'loading logic exporter', 'js/logic/logic-exporter.js'],
  [.761, 'loading logic templates', 'js/logic/logic-templates.js?v=0.7.4-audio-ownership-1'],
  ...
  [.795, 'loading editor core', 'js/editor/editor-core.js?v=0.7.4-smart-collider-dummies-1'],
  ...
  [.817, 'loading editor visual helpers', 'js/editor/visual-helpers.js?v=0.7.4-audio-collision-1'],
  [.84, 'loading editor asset library', 'js/editor/asset-library.js?v=0.7.4-fbx-import-1'],
  [.85, 'loading editor asset imports', 'js/editor/asset-imports.js?v=0.7.4-fbx-import-1'],
  ...
  [.88, 'loading level manager', 'js/editor/level-manager.js?v=0.7.4-complete-level-library-1'],
  [.89, 'loading player blueprints', 'js/editor/player-blueprints.js?v=0.7.4-native-player-off-1'],
  [.90, 'loading folder manager', 'js/editor/folder-manager.js'],
  [.91, 'loading keyboard shortcuts', 'js/editor/keyboard-shortcuts.js'],
  [.92, 'loading thumbnails', 'js/editor/thumbnail-manager.js?v=0.7.4-three-r185-1'],
  ...
  [.9298, 'loading side panel controls', 'js/editor/side-panels.js'],
	  ...
	  [.9299, 'loading asset panel helpers', 'js/editor/asset-panel.js?v=0.7.4-fbx-import-1'],
  [.92991, 'loading asset properties', 'js/editor/asset-properties.js?v=0.7.4-fbx-import-1'],
  ...
  [.92995, 'loading scene outliner', 'js/editor/outliner.js?v=0.7.4-logic-pawn-eye-1'],
  [.929952, 'loading selection manager', 'js/editor/selection-manager.js?v=0.7.4-selection-rebuild-1'],
  [.929955, 'loading history manager', 'js/editor/history-manager.js'],
  [.92996, 'loading project io', 'js/editor/project-io.js?v=0.7.4-private-demo-workspace-1'],
  ...
  [.92998, 'loading material editor', 'js/editor/material-editor.js?v=0.7.4-persistence-audit-1'],
  [.929982, 'loading mesh editor', 'js/editor/mesh-editor.js'],
  [.929985, 'loading object inspector', 'js/editor/object-inspector.js?v=0.7.4-logic-pawn-eye-1'],
  ...
  [.929992, 'loading player lights inspector', 'js/editor/player-lights-inspector.js?v=0.7.4-split-rear-colors-1'],
  [.929994, 'loading player attachments inspector', 'js/editor/player-attachments-inspector.js'],
  [.929996, 'loading player setup inspector', 'js/editor/player-setup-inspector.js?v=0.7.4-native-player-off-1'],
  [.929998, 'loading hud inspector', 'js/editor/hud-inspector.js?v=0.7.4-audio-ownership-1'],
  [.929999, 'loading environment inspector', 'js/editor/environment-inspector.js?v=0.7.4-cinematic-flare-1'],
  [.9299991, 'loading rendering inspector', 'js/editor/rendering-inspector.js?v=0.7.4-reflections-r185-1'],
  [.9299992, 'loading Pawn Studio', 'js/editor/pawn-studio.js?v=0.7.4-slot-transform-1'],
  [.9299993, 'loading logic inspector', 'js/editor/logic-elements-inspector.js?v=0.7.4-audio-collision-1'],
  [.9299995, 'loading inspector controller', 'js/editor/inspector-controller.js?v=0.7.4-smart-collider-dummies-1'],
  ...
  [.9299997, 'loading editor runtime', 'js/editor/editor-runtime.js?v=0.7.4-shader-warmup-1'],
  ...
  [.95, 'starting editor', 'js/editor/editor.js?v=0.7.4-audio-collision-1'],
]);
...
function ensureEditor(){
  ...
  loading = Promise.resolve()
    ...
    .then(() => { editorStage(.45, 'loading editor style'); return loadCss('css/editor.css?v=0.7.4-storage-assistant-2'); })
