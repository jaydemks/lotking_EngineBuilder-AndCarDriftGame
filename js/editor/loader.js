...
function ensureEditor(){
  ...
  document.querySelectorAll('script[data-lk-src^="js/editor/"], script[src^="js/editor/editor.js"], script[src^="js/editor/editor-template.js"], script[src^="js/editor/viewport-picking.js"], script[src^="js/editor/context-menu.js"], script[src^="js/editor/asset-imports.js"], script[src^="js/editor/level-manager.js"], script[src^="js/editor/player-blueprints.js"], script[src^="js/editor/folder-manager.js"], script[src^="js/editor/keyboard-shortcuts.js"], script[src^="js/editor/thumbnail-manager.js"], script[src^="js/editor/floating-layout.js"], script[src^="js/editor/preferences.js"], script[src^="js/editor/quick-audio.js"], script[src^="js/editor/toolbar.js"], script[src^="js/editor/side-panels.js"], script[src^="js/editor/editor-menus.js"], script[src^="js/editor/asset-panel.js"], script[src^="js/editor/outliner.js"], script[src^="js/editor/inspector-ui.js"], script[src^="js/editor/music-library-panel.js"], script[src^="js/editor/material-editor.js"], script[src^="js/editor/object-inspector.js"], script[src^="js/editor/player-camera-inspector.js"], script[src^="js/editor/player-lights-inspector.js"], script[src^="js/editor/player-attachments-inspector.js"], script[src^="js/editor/player-setup-inspector.js"], script[src^="js/editor/hud-inspector.js"], script[src^="js/editor/playable-export.js"]').forEach(s => s.remove());
