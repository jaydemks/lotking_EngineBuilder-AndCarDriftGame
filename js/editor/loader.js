...
const EDITOR_SCRIPT_STAGES = Object.freeze([
  ...
  [.731, 'loading gameplay difficulty', 'js/runtime/gameplay-difficulty.js?v=0.7.1-gameplay-difficulty-1'],
  ...
  [.75, 'loading device visuals', 'js/runtime/input/device-visuals.js'],
	  ...
	  [.7555, 'loading P2P session transport', 'js/runtime/p2p-session.js?v=0.7.1-p2p-session-1'],
	  [.756, 'loading plugin api', 'js/plugins/plugin-api.js?v=0.7.1-pawn-studio-1'],
	  ...
	  [.7584, 'loading portable cloth runtime', 'js/runtime/cloth-system.js?v=0.7.1-cloth-studio-2'],
	  [.7585, 'loading FBX import plugin', 'js/plugins/fbx-import-plugin.js?v=1.0.2'],
	  [.7586, 'loading Cloth Studio plugin', 'js/plugins/cloth-authoring-plugin.js?v=0.7.1-cloth-studio-2'],
	  [.7587, 'loading P2P collaboration plugin', 'js/plugins/p2p-collaboration-plugin.js?v=0.7.1-p2p-session-1'],
	  [.76, 'loading logic graph', 'js/logic/logic-graph.js?v=0.7.1-free-camera-1'],
  [.7605, 'loading logic exporter', 'js/logic/logic-exporter.js'],
  [.761, 'loading logic templates', 'js/logic/logic-templates.js?v=0.7.1-audio-ownership-1'],
  [.7612, 'loading soccer templates', 'js/logic/logic-templates-soccer.js?v=0.7.1-free-camera-1'],
  [.7614, 'loading character templates', 'js/logic/logic-templates-character.js?v=0.7.1-free-camera-1'],
  [.762, 'loading logic registry', 'js/logic/logic-registry.js'],
  [.763, 'loading logic validator', 'js/logic/logic-validator.js'],
  [.764, 'loading logic services', 'js/logic/logic-services.js?v=0.7.1-p2p-session-1'],
  [.765, 'loading logic runtime', 'js/logic/logic-runtime.js?v=0.7.1-p2p-session-1'],
  ...
  [.7666, 'loading network logic nodes', 'js/logic/logic-nodes-network.js?v=0.7.1-p2p-session-1'],
  [.767, 'loading logic runner', 'js/runtime/logic-elements-runner.js?v=0.7.1-audio-ownership-1'],
  [.795, 'loading editor core', 'js/editor/editor-core.js?v=0.7.1-smart-collider-dummies-1'],
  [.797, 'loading editor layout', 'js/editor/editor-layout.js'],
  [.80, 'loading editor viewport tools', 'js/editor/viewport-picking.js?v=0.7.1-smart-collider-dummies-1'],
  [.805, 'loading editor viewport events', 'js/editor/viewport-events.js?v=0.7.1-smart-collider-dummies-1'],
  [.81, 'loading editor fly camera', 'js/editor/fly-camera.js'],
  [.815, 'loading editor gizmo controls', 'js/editor/gizmo-controls.js'],
  [.817, 'loading editor visual helpers', 'js/editor/visual-helpers.js?v=0.7.1-audio-collision-1'],
  [.84, 'loading editor asset library', 'js/editor/asset-library.js?v=0.7.1-fbx-import-1'],
  [.85, 'loading editor asset imports', 'js/editor/asset-imports.js?v=0.7.1-fbx-import-1'],
  ...
  [.88, 'loading level manager', 'js/editor/level-manager.js?v=0.7.1-complete-level-library-1'],
  [.89, 'loading player blueprints', 'js/editor/player-blueprints.js?v=0.7.1-native-player-off-1'],
  [.90, 'loading folder manager', 'js/editor/folder-manager.js'],
  [.91, 'loading keyboard shortcuts', 'js/editor/keyboard-shortcuts.js'],
  [.92, 'loading thumbnails', 'js/editor/thumbnail-manager.js?v=0.7.1-three-r185-1'],
  [.925, 'loading floating layout', 'js/editor/floating-layout.js'],
  [.928, 'loading editor preferences', 'js/editor/preferences.js?v=0.7.1-audio-collision-1'],
  [.9285, 'loading editor welcome', 'js/editor/welcome-overlay.js'],
  [.929, 'loading quick audio controls', 'js/editor/quick-audio.js?v=0.7.1-audio-collision-1'],
  [.9295, 'loading editor template', 'js/editor/editor-template.js?v=0.7.1-audio-collision-1'],
  [.9296, 'loading developer debugger', 'js/editor/developer-debugger.js?v=0.7.1-developer-debugger-3'],
  [.9297, 'loading editor toolbar', 'js/editor/toolbar.js?v=0.7.1-audio-collision-1'],
  [.9298, 'loading side panel controls', 'js/editor/side-panels.js'],
	  ...
	  [.9299, 'loading asset panel helpers', 'js/editor/asset-panel.js?v=0.7.1-fbx-import-1'],
  [.92991, 'loading asset properties', 'js/editor/asset-properties.js?v=0.7.1-fbx-import-1'],
  [.92992, 'loading asset catalog', 'js/editor/asset-catalog.js'],
  [.92993, 'loading asset drag and drop', 'js/editor/asset-dnd.js?v=0.7.1-fbx-import-1'],
  [.92995, 'loading scene outliner', 'js/editor/outliner.js?v=0.7.1-logic-pawn-eye-1'],
  [.929952, 'loading selection manager', 'js/editor/selection-manager.js?v=0.7.1-selection-rebuild-1'],
  [.929955, 'loading history manager', 'js/editor/history-manager.js'],
  [.92996, 'loading project io', 'js/editor/project-io.js?v=0.7.1-audio-ownership-1'],
  [.929961, 'loading input settings', 'js/editor/input-settings.js'],
  [.929965, 'loading add actions', 'js/editor/add-actions.js?v=0.7.1-character-ground-1'],
  [.929967, 'loading scene menu actions', 'js/editor/scene-menu-actions.js'],
  [.92997, 'loading inspector ui', 'js/editor/inspector-ui.js'],
  [.929975, 'loading music library panel', 'js/editor/music-library-panel.js?v=0.7.1-audio-collision-1'],
  [.92998, 'loading material editor', 'js/editor/material-editor.js?v=0.7.1-persistence-audit-1'],
  [.929982, 'loading mesh editor', 'js/editor/mesh-editor.js'],
  [.929985, 'loading object inspector', 'js/editor/object-inspector.js?v=0.7.1-logic-pawn-eye-1'],
  [.92999, 'loading player camera inspector', 'js/editor/player-camera-inspector.js'],
  [.929991, 'loading player collider inspector', 'js/editor/player-collider-inspector.js?v=0.7.1-smart-collider-dummies-1'],
  [.929992, 'loading player lights inspector', 'js/editor/player-lights-inspector.js?v=0.7.1-split-rear-colors-1'],
  [.929994, 'loading player attachments inspector', 'js/editor/player-attachments-inspector.js'],
  [.929996, 'loading player setup inspector', 'js/editor/player-setup-inspector.js?v=0.7.1-native-player-off-1'],
  [.929998, 'loading hud inspector', 'js/editor/hud-inspector.js?v=0.7.1-audio-ownership-1'],
  [.929999, 'loading environment inspector', 'js/editor/environment-inspector.js?v=0.7.1-cinematic-flare-1'],
  [.9299991, 'loading rendering inspector', 'js/editor/rendering-inspector.js?v=0.7.1-reflections-r185-1'],
  [.9299992, 'loading Pawn Studio', 'js/editor/pawn-studio.js?v=0.7.1-slot-transform-1'],
  [.9299993, 'loading logic inspector', 'js/editor/logic-elements-inspector.js?v=0.7.1-audio-collision-1'],
  [.9299995, 'loading inspector controller', 'js/editor/inspector-controller.js?v=0.7.1-smart-collider-dummies-1'],
  [.9299996, 'loading cinema studio', 'js/editor/cinema-studio.js'],
  [.92999965, 'loading viewport layout', 'js/editor/viewport-layout.js?v=0.7.1-three-r185-1'],
  [.9299997, 'loading editor runtime', 'js/editor/editor-runtime.js?v=0.7.1-shader-warmup-1'],
  [.9299998, 'loading playable export level picker', 'js/editor/playable-export-level-picker.js'],
  [.92999985, 'loading playable export assets', 'js/editor/playable-export-assets.js?v=0.7.1-audio-ownership-1'],
  [.9299999, 'loading playable export zip', 'js/editor/playable-export-zip.js?v=0.7.1-three-r185-1'],
  [.93, 'loading playable export', 'js/editor/playable-export.js?v=0.7.1-persistence-audit-1'],
  [.95, 'starting editor', 'js/editor/editor.js?v=0.7.1-audio-collision-1'],
]);
...
function ensureEditor(){
  ...
  loading = Promise.resolve()
    ...
    .then(() => { editorStage(.45, 'loading editor style'); return loadCss('css/editor.css?v=0.7.1-slot-transform-1'); })
