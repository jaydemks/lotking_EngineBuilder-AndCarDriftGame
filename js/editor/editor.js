...
root.innerHTML = `
  ...
  <div id="lkPrefsOverlay"><div class="lk-prefs-panel">
    ...
    <div class="lk-prefs-tabs"><button data-prefs-tab="interface" class="on" type="button" data-pref-i18n="tabInterface">Interface</button><button data-prefs-tab="theme" type="button" data-pref-i18n="tabTheme">Theme</button><button data-prefs-tab="language" type="button" data-pref-i18n="tabLanguage">Language</button></div>
