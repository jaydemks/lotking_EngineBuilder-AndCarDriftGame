...
function create(deps){
  ...
  const CHROME_I18N = [
    ...
    ['#lkExportProject', 'text', {en:'⇩ Export single LKEP', it:'⇩ Esporta LKEP singolo'}],
    ['#lkExportProjectFolder', 'text', {en:'⇩ Export project folder (GitHub)', it:'⇩ Esporta cartella progetto (GitHub)'}],
    ['#lkImportProjectFolder', 'text', {en:'⇧ Import project folder', it:'⇧ Importa cartella progetto'}],
