...
'use strict';
  ...
  <div id="lkPrefsOverlay"><div class="lk-prefs-panel">
    ...
    <div class="lk-prefs-tabs"><button data-prefs-tab="interface" class="on" type="button" data-pref-i18n="tabInterface">Interface</button><button data-prefs-tab="general" type="button" data-pref-i18n="tabGeneral">Project General</button><button data-prefs-tab="storage" type="button" data-pref-i18n="tabStorage">Storage</button><button data-prefs-tab="theme" type="button" data-pref-i18n="tabTheme">Theme</button><button data-prefs-tab="language" type="button" data-pref-i18n="tabLanguage">Language</button><button data-prefs-tab="controls" type="button" data-pref-i18n="tabControls">Game Input</button><button data-prefs-tab="editorKeys" type="button" data-pref-i18n="tabEditorKeys">Editor Keys</button><button data-prefs-tab="viewport" type="button" data-pref-i18n="tabViewport">Viewport</button></div>
    <div class="lk-prefs-body">
      ...
      <div data-prefs-sec="storage" class="lk-prefs-sec"><div id="lkStorageManager" class="lk-storage-manager"></div></div>
