...
function create(deps){
  ...
  function fileItems(){
    return [
      ...
      {label:tr('Import Project Folder', 'Importa cartella progetto'), icon:'⇧', action:deps.importProjectFolder},
      {label:tr('Export Project', 'Esporta progetto'), icon:'⇩', action:deps.exportProject},
      {label:tr('Export Project Folder', 'Esporta cartella progetto'), icon:'⇩', action:deps.exportProjectFolder},
