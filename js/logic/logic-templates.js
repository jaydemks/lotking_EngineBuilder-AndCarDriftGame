...
function playerCarTemplateGraph(){
  const g = graph('Template - Player Car Logic Element', [
    ...
    {name:'CameraMode', type:'string', value:'free', exposed:true, binding:'camera.mode', label:'Camera Mode', category:'Camera', ui:'select', options:[{value:'free',label:'Free'},{value:'interior',label:'Interior'},{value:'arcade',label:'Arcade'},{value:'cinematic',label:'Cinematic'}]},
  ...
  g.logicScene = {
    ...
    elements:[
      ...
      {id:'vehicle_fuel_tank', name:'Fuel Tank Damage Dummy', type:'empty', parentId:'root', linked:true, dummyVisible:false, vehicleDamageAnchor:'fuelTank', position:[-.72,.48,-1.18], rotation:[0,0,0], scale:[1,1,1], color:'#ffb52e'},
      {id:'vehicle_engine_smoke', name:'Engine Smoke Dummy', type:'empty', parentId:'root', linked:true, vehicleDamageAnchor:'engineSmoke', position:[0,.72,.82], rotation:[0,0,0], scale:[1,1,1], color:'#667788'},
      {id:'vehicle_exhaust', name:'Exhaust / Muffler Damage Dummy', type:'empty', parentId:'root', linked:true, vehicleDamageAnchor:'exhaust', position:[0,.42,-1.72], rotation:[0,0,0], scale:[1,1,1], color:'#667788'},
  ...
  g.vehiclePawn = {template:true, schemaVersion:2, cameraDefaultVersion:3, id:'player-car-logic', playerId:1, enabled:true, hidden:false, possessed:true, proceduralFallback:'native-player-visual-v1', modelShading:'original', collision:{mass:1200}, suspension:{stiffness:32,restLength:.34,travel:.28,radius:.38,compression:4.4,relaxation:2.6,rollInfluence:.22}, camera:{mode:'free',distance:9,height:3.1,lag:5.8,fov:70,interiorCameraVersion:3,interiorHeight:1.15,interiorForward:.28,interiorLateral:-.42,interiorLookHeight:.04,interiorFov:72,interiorLag:18,interiorGForceMotion:0,interiorAccelerationMotion:0,interiorRoadShake:0,interiorMotionLimit:.035,interiorSpeedFovGain:.025,interiorSpeedFovMax:4.5}, damage:{enabled:true,maxEnergy:850,fuelTank:{enabled:true,position:[-.72,.48,-1.18],radius:.42,damageMultiplier:2.5,dummyVisible:true},engineSmoke:{position:[0,.72,.82],dummyVisible:true},exhaust:{position:[0,.42,-1.72],dummyVisible:true},smokeThreshold:.62,fireThreshold:.28,smokeRate:8,fireRate:14,explosion:{delay:.75,radius:7,force:120,detachWheels:true,blacken:true}}, lights:{enabled:true,front:{enabled:true},rear:{enabled:true},highBeamsEnabled:true}, effects:{neonEnabled:true,exhaustEnabled:true,skidEnabled:true,smokeIntensity:1,skidLife:12}, skids:{enabled:true,smokeModelVersion:4,smokeEnabled:true,smokeAmount:.28,smokeThreshold:.42,smokeMinHeat:.58,smokeHeatRate:.38,smokeCoolRate:.32,smokeMinSpeedKmh:24,smokeMinSlipAngle:.14,smokeOnDrift:true,smokeOnBrake:true,smokeOnAcceleration:true}, engineAudio:{enabled:true,volume:.28,pitch:1}, radio:{enabled:true}, dataWidgets:{enabled:true}, driveSetup:{torque:3,horsepower:360,maxSpeed:4,oversteer:1,handbrake:2,steer:2,brake:0,grip:1,reverseDelay:.5,suspension:2,damping:4,travel:0,ride:0,roll:-4,chassisLift:0}, tuning:{horsepower:360,torque:3,maxSpeed:42.8,acceleration:11.252,brake:18,reverseSpeed:12,steer:2.2222,grip:.82836,frontGrip:.83499,rearGrip:.80185,drag:1.8}};
  g.vehiclePawn.damage.fuelTank.dummyVisible = false;
  g.vehiclePawn.steeringWheel = {enabled:true,pivotName:'steering_wheel_pivot',meshName:'steering_wheel_mesh',driverSide:'auto',axis:'auto',direction:0,inputLockDegrees:0,visualLockDegrees:0,response:12};
