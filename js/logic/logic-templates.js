...
function playerCarTemplateGraph(){
  ...
  g.logicScene = {
    ...
    elements:[
      ...
      {id:'vehicle_fuel_tank', name:'Fuel Tank Damage Dummy', type:'empty', parentId:'root', linked:true, vehicleDamageAnchor:'fuelTank', position:[-.72,.48,-1.18], rotation:[0,0,0], scale:[1,1,1], color:'#ffb52e'},
